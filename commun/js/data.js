...
export const data = {
    ...
    set : function(forcer=false){
        ...
        if (donnerActuel == null || forcer){
            const donnerUtilisateur = { utilisateurs : [{nom : "van der eecken", prenom : "philippe", age : 59, statut : "éleve", mail : "", desciption : "un des 4 fondateur du site", objectifPersonel : "", photo:photoPhilippe, couleur:"vert", resaux : {instagrame : "", in : "", facebookin : "", twitter : ""}, badges : {profil100:false, compte10:false, jeux:false, boutonSecrt:false}, id : 0},
                {nom : "fiquet", prenom : "clément", age : 17, statut : "éleve", mail : "", desciption : "un des 4 fondateur du site", objectifPersonel : "", photo:photoClement, couleur:"vert", resaux : {instagrame : "emmanuelmacron", in : "emmanuelmacron", facebookin : "EmmanuelMacron", twitter : "elonmusk"}, badges : {profil100:false, compte10:false, jeux:false, boutonSecrt:false}, id : 1},
                {nom : "fabien", prenom : "fabien", age : 19, statut : "éleve", mail : "", desciption : "un des 4 fondateur du site", objectifPersonel : "", photo:photoFabien, couleur:"vert", resaux : {instagrame : "spacex", in : "", facebookin : "", twitter : ""}, badges : {profil100:false, compte10:false, jeux:false, boutonSecrt:false}, id : 2},
                {nom : "", prenom : "", age : null, statut : "none", mail : "", desciption : "", objectifPersonel : "", photo:photoDefaut, couleur:"vert", resaux : {instagrame : "", in : "", facebookin : "", twitter : ""}, badges : {profil100:false, compte10:false, jeux:false, boutonSecrt:false}, id : 3}
